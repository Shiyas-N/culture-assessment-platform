...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($input['rule_name']) && isset($input['rule_type'])) {
        $rule_id = $ruleController->createRule($input['rule_name'], $input['rule_type']);
        ...
        echo json_encode(['error' => 'Missing rule_name or rule_type']);
    }
